...
var clock = new FlipClock(el, 6600, {
  ...
  //   formValidation.whenValid({
  //     group: 'block-' + currentTab
  //   }).done(function() {
  //     $('.nextStep').prop('disabled', false);
  //   })
  //   .fail(function(){
  //     formValidation.refresh()
...
var currentTab = 0;
  ...
  function validate(){
    ...
    // window.Parsley.addAsyncValidator('validEmail', function (xhr) {
    //   if(xhr.status != 200 ){
    //     return true
    //   }else{
    //     return xhr.responseJSON.status == "Valid"
    //   }
    // },"https://go.webformsubmit.com/dukeleads/restapi/v1.2/validate/email?key=50f64816a3eda24ab9ecf6c265cae858",{ "type": "POST", "dataType": "json", "data": {"value": "current"+sdsa+"Tab"} });
    
    // window.Parsley.addAsyncValidator('validPhone', function (xhr) {
    //   if(xhr.status != 200 ){
    //     return false
    //   }else{
    //     return xhr.responseJSON.status == "Valid"
    //   }
    // },"https://go.webformsubmit.com/dukeleads/restapi/v1.2/validate/mobile?key=50f64816a3eda24ab9ecf6c265cae858");
    ...
    var customer_type = isBadCustomer( getUrlParameter('keyword')) || (getUrlParameter('bc') == "yes");
      var e = JSON.parse(localStorage.getItem("parameters"))
        ...
        return  n = {
          ...
          trafficid: getUrlParameter('trafficid') || "MEGA-MOBILE-DEALS",
  ...
  function postData(campId='',successUrl='') {
      var e = getData();
